...
const passwordOutput = document.getElementById("password-error");
const passwordBorder = document.getElementById("password");
const confirmationOutput = document.getElementById("confirm-error");
const confirmationBorder = document.getElementById("confirm");
...
form.addEventListener("submit", (event) => {
  ...
  const radio = formData.get("gender");
